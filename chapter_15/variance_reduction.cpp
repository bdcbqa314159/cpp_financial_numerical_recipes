...
int main()
{
    ...
    std::cout << "Simulated call option price = "
              ...
              << "\n";
    std::cout << "Simulated call option price, CV = "
              << derivative_price_simulate_european_generic_with_control_variate(S, K, r, sigma, time,
                                                                                 pay_off_call, no_sims)
              << "\n";
    std::cout << "Simulated call option price, AV = "
    ...
    std::cout << "Simulated put option price, CV = "
              << derivative_price_simulate_european_generic_with_control_variate(S, K, r, sigma, time,
                                                                                 pay_off_put, no_sims)
              << "\n";
    std::cout << "Simulated put option price, AV = "
              << derivative_price_simulate_european_generic_with_antithetic_variate(S, K, r, sigma, time,
                                                                                    pay_off_put, no_sims)
              << "\n";
